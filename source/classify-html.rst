...
.. csv-table::
    ...
    "classification_type (*optional*)", "integer", "Select the classification method: ``1`` for rule-based, ``2`` for model-based, or ``0`` for a hybri rule-based + model-based (defaults to ``0``)"
